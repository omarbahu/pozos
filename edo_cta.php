...
<div id="contenedor">
		...
		<nav class="nav right">
			<ul>
				<?php if ($admin=="ON") { ?>
				<li><a href="#">Menu</a></li>
				<li class="current"><a href="edo_cta.php?admin=ON">Edo de Cta</a></li>
				...
				<?php } else {?>
				<li><a href="#">Menu</a></li>
				<li class="current"><a href="edo_cta.php">Edo de Cta</a></li>
...
<select name="pago1" id="pago1" data-native-menu="false">
...
<?php } ?>
	...
	<td class="Titulo">
		<button id="generar1" >Ver</button>
		
	</td>	
	<td class="TituloExc"><button id="excel">Excel</button></td>
      </tr>
	</tbody>
	</table>
...
<iframe frameborder="0" scrolling="yes" id="iframe_resultados"></iframe>
  </div>
</div>
...
$(document).ready(function() {
  ...
  $(function() {
	...
	$( "#generar1" ).on("click", function(){
		//alert("1");
		$('#iframe_resultados').attr('src', "grid_edocta.php?anio="+ $( "#number" ).val() +"&pago=" + $( "#pago1" ).val());
            	/*
		var parametros = {
            		"anio" : $( "#number" ).val(),
			"pago" : $( "#pago1" ).val()
  ...
  $( "#excel" ).on("click", function(e){
                ...
                $(location).attr('href',"grid_edocta_excel.php?anio="+ $( "#number" ).val() + "&pago=" + $( "#pago1" ).val(), '_new');
                 //window.open('url', 'excel', 'window settings');
  //return false;
            });
  });
