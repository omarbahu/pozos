...
<head>
	...
	<link type="text/css" rel="stylesheet" media="all" href="http://bs-it.com.mx/cueva-santa/demo_cal/estilos.css">
...
<header>
	...
	function generar_calendario(mes,anio)
	{
		...
		$.ajax({
			type: "GET",
			url: "demo_cal/ajax_calendario.php",
			cache: false,
	...
	function formatDate (input) {
		...
		$(document).ready(function()
		{
			...
			$(document).on("click",'a.modal',function(e) 
			{
				...
				$.ajax({
					type: "GET",
					url: "demo_cal/ajax_calendario.php?admin=<?php echo $admin; ?>",
					cache: false,
			...
			$(document).on("click",'.enviar',function (e) 
			{
				...
				//{
					$("#respuesta_form").html("<img src='demo_cal/images/loading.gif'>");
